# HARRY POTTER คณิตเวทมนตร์

เกมคณิตศาสตร์ผจญภัยในโลกเวทมนตร์สำหรับผู้เรียนระดับประถม

- Production: https://ppeeradet.github.io/MagicMath01/
...
- `harrypotter_math_Res_Save.html` — duplicate legacy; SHA-256 เหมือน `index.html` ณ วันที่ตรวจ
